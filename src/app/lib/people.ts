...
const girls = ['Rupkatha De', 'Poulami Karmakar', 'Madhulika Majumder', 'Sharanya Giri','Nayoneeka','Dhriti','Diksha Banik','Nandini','Sreyashi','Aishani','Diya Das','Rishima Chowdhury','Priya Jha','Meghna','Meghavika','Dehali'];
